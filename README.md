این هم یک فایل **`README.md`** حرفه‌ای و کاملاً استاندارد به زبان انگلیسی (همراه با بخش‌های فارسی) برای گیت‌هاب، تا دیگران (و خودت در آینده) بتوانی از این دستورالعمل برای انتقال بدون ریسک سیستم‌عامل‌های مبتنی بر RedHat/CentOS/Rocky/Alma به دیسک جدید LVM استفاده کنی:
